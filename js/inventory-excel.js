...
(function (global) {
  ...
  function rowToOrderLine(o) {
    ...
    return {
      ...
      batch_number: (r.batch_number || r.batch || r.batch_no || "").trim() || null,
      expiry_date: cellToIsoDate(r.expiry_date || r.expiry || r.exp || r.exp_date || r.expiry_date),
      morning: r.morning,
      noon: r.noon,
      evening: r.evening,
      night: r.night,
        ...
        return p.then(function () {
          ...
          for (i = 0; i < lines.length; i++) {
            ...
            dbLines.push({
              ...
              expiry_date: cellToIsoDate(ln.expiry_date) || null,
  ...
  function downloadSampleInventoryExcel() {
    ...
    var lotLines = [
      ...
      ["INV-2025-001", "PARA-500", "", 1, 120, 120, "2025-03-03", "B001", "2026-03-01", 35.0],
      ["INV-2025-001", "AMOX-500", "", 1, 60, 60, "2025-03-03", "B002", "2026-04-01", 125.5],
      ["INV-2025-001", "OME-20", "", 1, 90, 90, "2025-03-03", "B003", "2026-05-01", 48.0],
      ["INV-2025-002", "ORS-200", "", 1, 200, 200, "2025-03-12", "B004", "2026-06-01", 22.0],
      ["INV-2025-002", "AZI-500", "", 1, 30, 30, "2025-03-12", "B005", "2026-07-01", 180.0],
      ["INV-2025-002", "PARA-500", "", 1, 50, 50, "2025-03-12", "B006", "2026-08-01", 35.0],
      ["INV-2025-003", "CET-10", "", 1, 100, 100, "2025-03-16", "B007", "2026-09-01", 12.5],
      ["INV-2025-003", "IBU-400", "", 1, 80, 80, "2025-03-16", "B008", "2026-10-01", 18.0],
      ["INV-2025-003", "RAN-150", "", 1, 60, 60, "2025-03-16", "B009", "2026-11-01", 8.5],
      ["INV-2025-003", "MET-500", "", 1, 200, 200, "2025-03-16", "B010", "2026-12-01", 4.2],
      ["INV-2025-003", "GLI-1", "", 1, 90, 90, "2025-03-16", "B011", "2026-11-15", 6.75],
      ["INV-2025-003", "ATO-10", "", 1, 70, 70, "2025-03-16", "B012", "2026-12-15", 45.0],
      ["INV-2025-003", "LOS-50", "", 1, 50, 50, "2025-03-16", "B013", "2026-08-15", 28.0],
      ["INV-2025-003", "PAN-40", "", 1, 60, 60, "2025-03-16", "B014", "2026-09-15", 52.0],
      ["INV-2025-003", "DEXT-SYR", "", 1, 40, 40, "2025-03-16", "B015", "2026-10-15", 95.0],
      ["INV-2025-003", "COUGH-SYR", "", 1, 35, 35, "2025-03-16", "B016", "2026-11-15", 88.0],
      ["INV-2025-003", "VITD-60K", "", 1, 24, 24, "2025-03-16", "B017", "2026-12-15", 42.0],
      ["INV-2025-003", "CAL-D3", "", 1, 100, 100, "2025-03-16", "B018", "2026-09-30", 5.5],
      ["INV-2025-003", "BETA-OINT", "", 1, 48, 48, "2025-03-16", "B019", "2026-10-30", 65.0],
      ["INV-2025-003", "METRO-400", "", 1, 72, 72, "2025-03-16", "B020", "2026-11-30", 9.25],
      ["INV-2025-003", "LEVO-5", "", 1, 84, 84, "2025-03-16", "B021", "2026-12-30", 14.5],
    ];
    ...
    var orderLinesSheet = [
      ...
      ["ORD-1001", "PARA-500", "", 2, 500, "", "B001", "2026-03-01", 1, 0, 0, 0, "After food"],
